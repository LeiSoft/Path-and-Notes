...
Redis 可以存储键和五种不同类型的值之间的映射。键的类型只能为字符串，值支持五种数据类型：字符串、列表、[集合](https://so.csdn.net/so/search?q=集合&spm=1001.2101.3001.7020)、散列表、有序集合。
...
![在这里插入图片描述](assets/1504f508c3ca402991793d062000bb66.png)

**高并发：**

直接操作缓存能够承受的请求是远远大于直接访问数据库的，所以我们可以考虑把数据库中的部分数据转移到缓存中去，这样用户的一部分请求会直接到缓存这里而不用经过数据库。
![在这里插入图片描述](assets/b6d2cdaf1c0345399b0613b90b8d75ce.png)
...
![在这里插入图片描述](assets/74cbf7db358e40f18a0f978488f44924.png)
...
![在这里插入图片描述](assets/1a750d2a0d1348f083c194147cb2a57d.png)
...
![在这里插入图片描述](assets/c1b8f5a8a0fc4cef99c359d5db4d5ec4.png)
...
![在这里插入图片描述](assets/6cf1d468562241d896acf79153691486.png)
...
![在这里插入图片描述](assets/a0483bc7c58c4f0ea5310099aa69d42a.png)
...
![在这里插入图片描述](assets/af6f2a7f67aa4ec0836dc9de50569b30.png)
...
![在这里插入图片描述](assets/eab4774e9c3441e6b21e31831ee36132.png)
...
单机的 redis，能够承载的 QPS 大概就在上万到几万不等。对于缓存来说，一般都是用来支撑读高并发的。因此架构做成主从(master-slave)架构，一主多从，主负责写，并且将数据复制到其它的 slave 节点，从节点负责读。所有的**读请求**全部走从节点。这样也可以很轻松实现水平扩容，**支撑读高并发**。
![在这里插入图片描述](assets/cd7176c771be41848c37266db696eaf3.png)
...
![在这里插入图片描述](assets/6279218c57d84ff699c84e80acc867b3.png)
...
![在这里插入图片描述](assets/fa67f570694f4f698021c73f7089b494.png)
...
![在这里插入图片描述](assets/ef405ab3e47d44d3948923ef753edda9.png)
...
![在这里插入图片描述](assets/751422724582471da9a0b54fc01104cf.png)
