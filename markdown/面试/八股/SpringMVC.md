...
## 1.1 什么是Spring [MVC](https://so.csdn.net/so/search?q=MVC&spm=1001.2101.3001.7020)？简单介绍下你对Spring MVC的理解？

Spring MVC是一个基于Java的实现了MVC设计模式的请求驱动类型的轻量级Web框架，通过把模型-视图-控制器分离，将web层进行职责解耦，把复杂的web应用分成逻辑清晰的几部分，简化开发，减少出错，方便组内开发人员之间的配合。

## 1.2 Spring MVC的优点 [集合](https://so.csdn.net/so/search?q=集合&spm=1001.2101.3001.7020)的特点主要有如下两点：
...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_20,color_FFFFFF,t_70,g_se,x_16-1661998191005839.png)
