...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_20,color_FFFFFF,t_70,g_se,x_16-1661998149547731.png)
...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_20,color_FFFFFF,t_70,g_se,x_16-1661998149547732.png)
...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_17,color_FFFFFF,t_70,g_se,x_16-1661998149547733.png)
...
## 3.9 Spring如何处理线程[并发](https://so.csdn.net/so/search?q=并发&spm=1001.2101.3001.7020)问题？
...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_20,color_FFFFFF,t_70,g_se,x_16-1661998149547734.png)
...
## 3.13 在 Spring中如何注入一个java[集合](https://so.csdn.net/so/search?q=集合&spm=1001.2101.3001.7020)？
...
@Controller：这将一个类标记为 Spring Web [MVC](https://so.csdn.net/so/search?q=MVC&spm=1001.2101.3001.7020) 控制器。标有它的 Bean 会自动导入到 IoC 容器中。
...
- 如何在 advice 中编写切面代码.
  ...
  ![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_20,color_FFFFFF,t_70,g_se,x_16-1661998149547735.png)
