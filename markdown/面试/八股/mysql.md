...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_16,color_FFFFFF,t_70,g_se,x_16-16619984324741370.png)
...
4、枚举类型（ENUM），把不重复的数据存储为一个预定义的[集合](https://so.csdn.net/so/search?q=集合&spm=1001.2101.3001.7020)。
...
- MEMORY引擎：所有的数据都在内存中，数据的处理速度快，但是安全性不高。
  ![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_16,color_FFFFFF,t_70,g_se,x_16-16619984324741371.png)
  ![在这里插入图片描述](assets/3b5cfcfc17d24b8d8e08d0ab9c93959b.png)
...
**Where**
![在这里插入图片描述](assets/750e60c187344dbc920ef44811bd38c3.png)
...
![在这里插入图片描述](assets/428e45273c4d4b2886a324cd3a17c340.png)
...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_19,color_FFFFFF,t_70,g_se,x_16-16619984324741372.png)
...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5Y2X5pa55pyJ6ZuoWWE=,size_13,color_FFFFFF,t_70,g_se,x_16-16619984324741373.png)
...
![在这里插入图片描述](assets/fba12b919edc4fa8a37373547ec7edf2.png)
...
![在这里插入图片描述](assets/b1df8a8fe5944539bfc132f5cd9f079b.png)
...
![在这里插入图片描述](assets/817704b2bf334b16b059628d890558b4.png)
...
![在这里插入图片描述](assets/95de355f0a23451f81f99360f0c56d73.png)
...
![在这里插入图片描述](assets/16bf61979a974da4be8a93cb211fe7df.png)
...
- 左外连接：LEFT OUTER JOIN, 以左表为主，先查询出左表，按照ON后的关联条件匹- - 配右表，没有匹配到的用NULL填充，可以简写成LEFT JOIN
...
![在这里插入图片描述](assets/0ddc819a27f24440b6b51725fc6df29b.png)

S表

![在这里插入图片描述](assets/e2f040f154114e1c92a9cf0f8501e7b4.png)

1. 交叉连接(笛卡尔积):
   select r.*,s.* from r,s

![在这里插入图片描述](assets/2263c469f89743838f2a4603f409f58d.png)

2.内连接结果：
select r.*,s.* from r inner join s on r.c=s.c

![在这里插入图片描述](assets/27ffd930d91b42cea2323e8d1a5befe8.png)

3.左连接结果：
select r.*,s.* from r left join s on r.c=s.c

![在这里插入图片描述](assets/1b86b891b68245789107e346d26cfeef.png)

4.右连接结果：
select r.*,s.* from r right join s on r.c=s.c

![在这里插入图片描述](assets/01471ae56c844bda9f209c2c2c06b0a6.png)

5.全表连接的结果（MySql不支持，Oracle支持）：
select r.*,s.* from r full join s on r.c=s.c

![在这里插入图片描述](assets/94a8a2683a144a9c893c1376fd582cbe.png)
...
![在这里插入图片描述](assets/be5215cb9a04476989f4214f7e59ba48.png)
...
![在这里插入图片描述](assets/37caef7a45a947258bb3449de9bff517.png)
...
![在这里插入图片描述](assets/6e41ae1bd2cf4bf8a9d5370b760226b4.png)
...
![在这里插入图片描述](assets/df402a5708eb450f92a206eb6d7c7973.png)
...
## 11.11 如果要存储用户的密码散列，应该使用什么字段进行存储？
...
![在这里插入图片描述](assets/e79f8b3b544048e2992ba54876121da9.png)
...
![在这里插入图片描述](assets/f56a5034f14d44f3accc4c441e6c1f8f.png)
...
![在这里插入图片描述](assets/73bf11c778d841f195f19197f4ae631a.png)
...
![在这里插入图片描述](assets/ca0c0765f44d4d689e8e00b016b513e1.png)
...
![在这里插入图片描述](assets/d6ffcba311f34eaba6445bec756dcddf.png)
...
**复制过程**
![在这里插入图片描述](assets/b2170d83fe1b485ab657c3cbf4a6df9c.png)
