...
下面我们实现一个静态代理demo:
![在这里插入图片描述](assets/a1fe59d684a54f16be3b5420358f0136.png)
...
![在这里插入图片描述](assets/b1fca512fb7949e88d57d31a057526ff.png)
...
![在这里插入图片描述](assets/5b58bbe552c646d1ab1690851daa347a.png)
...
![在这里插入图片描述](assets/7726fed1a8bd4a089a143df9f8eef973.png)
...
![在这里插入图片描述](assets/0a14194aee0047d4975d9b47b1eda2e5.png)
...
![在这里插入图片描述](assets/bb2b7db6374246d98aa289689a1d5f60.png)
...
![在这里插入图片描述](assets/f9761010a9354f3cbf5c7e8f00605bfd.png)

在理论计算机科学中，CAP定理（CAP theorem），又被称作布鲁尔定理（Brewer’s theorem），它指出对于一个分布式计算系统来说，不可能同时满足以下三点：
![在这里插入图片描述](assets/3281d56c338d4c8e9127227078fe01ef.png)
...
![在这里插入图片描述](assets/52d82c20ea0a44f78983d6f59cb82410.png)
...
![在这里插入图片描述](assets/7d96d54edfe94ca8841a2249cd7fb37e.png)
...
**BASE理论三要素**
![在这里插入图片描述](assets/07b28bdc82e54ec1afb8ecf8785ef49d.png)
...
# 3 [数据结构](https://so.csdn.net/so/search?q=数据结构&spm=1001.2101.3001.7020)与算法
...
![在这里插入图片描述](assets/acbd72386441480fac534a74ff0696c7.png)
...
- **单调性(Monotonicity)**
  单调性是指如果已经有一些内容通过哈希分派到了相应的缓冲中，又有新的缓冲区加入到系统中，那么哈希的结果应能够保证原有已分配的内容可以被映射到新的缓冲区中去，而不会被映射到旧的缓冲[集合](https://so.csdn.net/so/search?q=集合&spm=1001.2101.3001.7020)中的其他缓冲区。
- **分散性(Spread)**
...
![在这里插入图片描述](assets/ec45fbf4877a42ed9b90f4b0a6441025.png)

下一步将各个服务器使用Hash进行一次哈希，具体可以选择服务器的ip或主机名作为关键字进行哈希，这样每台机器就能确定其在哈希环上的位置，这里假设将上文中四台服务器使用ip地址哈希后在环空间的位置如下：
![在这里插入图片描述](assets/06e824e29c1e456987a2dd3e67104a1e.png)

接下来使用如下算法定位数据访问到相应服务器：将数据key使用相同的函数Hash计算出哈希值，并确定此数据在环上的位置，从此位置沿环顺时针“行走”，第一台遇到的服务器就是其应该定位到的服务器。

例如我们有Object A、Object B、Object C、Object D四个数据对象，经过哈希计算后，在环空间上的位置如下：
![在这里插入图片描述](assets/1b2759bb10e6410383b0bb73b753bb8c.png)
...
![在这里插入图片描述](assets/54ddb56017ee468aa5b9a4334c34f700.png)
