...
![image-20210115152427829](assets/image-20210115152427829.png)
...
![image-20210115155556662](assets/image-20210115155556662.png)
...
（和@Service和@Repository）用于自动检测和使用类路径扫描自动配置bean。注释类和bean之间存在隐式的一对一映射（即每个类一个bean）。
...
另外Spring的Starter机制，就是通过@Bean注解来定义bean。
